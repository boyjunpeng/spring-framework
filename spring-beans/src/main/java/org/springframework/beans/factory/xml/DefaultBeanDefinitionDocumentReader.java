...
public class DefaultBeanDefinitionDocumentReader implements BeanDefinitionDocumentReader {
	...
	public void registerBeanDefinitions(Document doc, XmlReaderContext readerContext) {
		...
		doRegisterBeanDefinitions(root);//解析xml配置文件bean的定义信息
	}
	...
	protected void doRegisterBeanDefinitions(Element root) {
		...
		preProcessXml(root);
		parseBeanDefinitions(root, this.delegate); //解析xml中Bean的定义信息
		postProcessXml(root);
	...
	protected BeanDefinitionParserDelegate createDelegate(
		...
		BeanDefinitionParserDelegate delegate = new BeanDefinitionParserDelegate(readerContext);  //创建一个bean定义解析器的委托实例
	...
	private void parseDefaultElement(Element ele, BeanDefinitionParserDelegate delegate) {
		if (delegate.nodeNameEquals(ele, IMPORT_ELEMENT)) {//解析<import/>标签
			...
			// recurse
			doRegisterBeanDefinitions(ele);//递归调用
		}
	}
	...
	protected void processBeanDefinition(Element ele, BeanDefinitionParserDelegate delegate) {
		...
		if (bdHolder != null) {
			...
			try {
				// Register the final decorated instance.//将BeanDefinitionHolder实例注册到DefaultListableBeanFactory容器中
